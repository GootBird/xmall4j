...
public class ShopCartOrderVO implements Serializable{
    ...
    private List<com.mall4j.cloud.common.order.vo.ShopCartItemVO> shopCartItemVO;
    ...
    public List<com.mall4j.cloud.common.order.vo.ShopCartItemVO> getShopCartItemVO() {
        return shopCartItemVO;
    }

    public void setShopCartItemVO(List<com.mall4j.cloud.common.order.vo.ShopCartItemVO> shopCartItemVO) {
